...
** configurações do appication 
```
api-ms-spring-cloud-configs/application.properties

oauth.client.name=myapp
oauth.client.secret=mayappsecret123
jwt.secret=DGM@I@2021!_OK
token.validity.seconds=86866
